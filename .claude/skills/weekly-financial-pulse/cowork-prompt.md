...
11. `🗂️ **Recomendaciones de ajustes en el plan de cuentas**` — ONLY include new/unresolved classification issues (duplicate accounts, uncategorized balances, mis-classified items, accounts split across categories). Skip items already cleaned up. If nothing new, omit this section.
